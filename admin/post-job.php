...
if(!isset($_SESSION['admin_session1']) || $_SESSION['admin_session1']!=$password){
    ...
    if(($_SERVER["REQUEST_METHOD"]=="POST") && isset($_POST['submit'])){
        try {
            $msg = $auth->insertJob($_POST,$_FILES);
        } catch (\Throwable $th) {
            $error = $th->getMessage();
        }
    }
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="#">Jobs</a></li>
                                        <li class="active">Upload Jobs</li>
                                    </ul>
                                </div>
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="">
                                          <div class="form-group has-success">
                                           ...
                                           <input type="text" name="title">
                                            ...
                                            <div class="form-group has-success">
                                            <label for="success" class="control-label">Job description</label>
                                            <div class="">
                                                <textarea placeholder="Job description" cols="80" rows="6" name="Job_description">
                                         ...
                                         <div class="form-group has-success">
                                            <label for="success" class="control-label">Job  Flyer or Banner</label>
                                            <div class="">
                                            <img id="list1"  style="width:20%; height:150px">
                                            <input type="file" name="banner" id="upfile1" accept="image/jpeg, image/png, image/jpg, image/gif" class="  input-rounded"  placeholder="upload" >
