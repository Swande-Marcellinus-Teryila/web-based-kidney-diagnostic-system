                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active" >Upload Diagnostic Question</li>
                                    </ul>
                                </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-title">
                                 <h2>Upload Diagnostic Questions</h2>
                                </div>
                            </div>
                                ...
                                <div class="panel-body" >
                                    <form method="post" enctype="multipart/form-data" action="">
                                         ...
                                         <div class="form-group has-success ">
                                            ...
                                            <div class="">
                                           <textarea name="question" placeholder="Diagnostic question" class="form-control" required="">
                                           </textarea>  
                                            </div>
                                        </div>
                                        <div class="form-group has-success ">
                                            <label for="success" class="control-label">Symthom for</label>
                                            <input type="checkbox" name="chronic" value="1">     <b>Chronic kidney disease</b> &nbsp;&nbsp;
                                            <input type="checkbox" name="acute" value="1">     <b>Acute kidney disease</b>&nbsp;&nbsp;
                                            <input type="checkbox" name="stone" value="1">     <b>Kidney Stone</b>&nbsp;&nbsp;
                                            <input type="checkbox" name="glo" value="1">     <strong>Glomerulonephritis</strong>
                                            ...
                                            <div class="">
                                            <input type="text" name="option1" value="Not at all" required="">                                        
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group has-success">
                                            ...
                                            <div class="">
                                            <input type="text" name="option2" value="Rarely">                                        
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group has-success">
                                            ...
                                            <div class="">
                                            <input type="text" name="option3" value="Often">                                        
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group has-success">
                                            ...
                                            <div class="">
                                            <input type="text" name="option4" value="Always">                                        
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group has-success">
                                            ...
                                            <div class="">
                                            <input type="text" name="causes"  placeholder="What causes the above problem(optional)">                                        
                                            </div>
                                        </div>
