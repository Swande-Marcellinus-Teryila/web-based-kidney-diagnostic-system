    ...
    header("location:../index.php");
       ...
       if(isset($_POST['delete'])){
        try {
            ...
            $auth->deleteSpecific('recommendation','id',$_POST['id']);
...
<html lang="en">
    <head>
        ...
        <title>view Recommendations| kidney diagnostic system</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">View Recommendations</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active"> Manage all Recommendations</li>
                                    </ul>
                                </div>
...
try {
    ...
    $results=$auth->displayAll('recommendation');
 ...
 <td><?Php echo $i?></td>                                    
             <td><?php echo $result['high_level'];?></td>
             <td><?php echo $result['low_level'];?></td>
                                                                                                            
                   <td>                               
       <form method="post">
               <input type="submit" value="Delete" name="delete" style="background-color:indianred; border-radius: 4px; color:white">
               <input type="hidden" name="id" value="<?=$result['id']?>">
           </form><!--a href="update-rec.php?id=<?=$result['id']?>" class="btn btn-primary"> <i class="fa fa-edit"></i> Edit</a-->
